 ...
 */
@WebServlet(urlPatterns = { "/Controller", "/inicio", "/login", "/usuario", "/sair", "/home", "/novoProduto",
      "/novoUsuario", "/novoFornecedor", "/cadastroProduto", "/novoLote", "/consultarEstoque", "/atualizarUsuario",
      "/atualizarEstoque", "/atualizacao" })
public class Controller extends HttpServlet {
   ...
   protected void novoIdProduto(HttpServletRequest request, HttpServletResponse response)
         throws ServletException, IOException {
   ...
   protected void novoLote(HttpServletRequest request, HttpServletResponse response)
         throws ServletException, IOException {
      Lote lote = new Lote();
   ...
   protected void lotesVencendo(HttpServletRequest request, HttpServletResponse response)
         throws ServletException, IOException {
   ...
   protected void consultarEstoque(HttpServletRequest request, HttpServletResponse response)
         throws ServletException, IOException {
   ...
   protected void atualizarEstoque(HttpServletRequest request, HttpServletResponse response)
         throws ServletException, IOException {
      Lote lote = new Lote();
   ...
   protected void atualizacao(HttpServletRequest request, HttpServletResponse response)
         throws ServletException, IOException {
      ArrayList<Lote> lista = dao.atualizacao();
      request.setAttribute("atualizacao", lista);
      RequestDispatcher rd = request.getRequestDispatcher("Atual-estoque.jsp");
      rd.forward(request, response);
   }
}
